...
const SettingsPanel = ({ data, token, teacherId }) => {
  ...
  useEffect(() => {
    // Update form when teacher data changes
  ...
  const handleProfileSubmit = async (e) => {
    ...
    try {
      const response = await axios.put(
        `${API_URL}/api/teacher/settings/${teacherId}`,
        {
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-md p-6 mb-8">
        ...
        <form onSubmit={handleProfileSubmit} className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">
                Email <span className="text-gray-500 dark:text-gray-400 font-normal">(Read-only)</span>
              </label>
              <input
                type="email"
                name="email"
          ...
          <button
            type="submit"
            disabled={loading}
            className="mt-6 px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-semibold transition disabled:opacity-50 disabled:cursor-not-allowed"
          >
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-md p-6">
        ...
        <form onSubmit={handlePasswordSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="mt-4 px-6 py-3 bg-red-600 hover:bg-red-700 text-white rounded-xl font-semibold transition disabled:opacity-50 disabled:cursor-not-allowed"
          >
